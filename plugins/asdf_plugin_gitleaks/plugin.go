...
var config = asdf.BinaryPluginConfig{
	...
	FileNameTemplate: "gitleaks_{{.Version}}_{{.Platform}}_{{.Arch}}.tar.gz",
	ArchMap: map[string]string{
		"amd64": "x64",
		"arm64": "arm64",
	},
	HelpDescription: "Gitleaks - Detect secrets in code",
	HelpLink:        "https://github.com/gitleaks/gitleaks",
	ArchiveType:     "tar.gz",
}

// New creates a new Gitleaks plugin instance.
func New() asdf.Plugin {
	return asdf.NewBinaryPlugin(&config)
}

// NewWithClient creates a new Gitleaks plugin with a custom GitHub client.
