...
var config = asdf.BinaryPluginConfig{
	...
	FileNameTemplate: "shfmt_v{{.Version}}_{{.Platform}}_{{.Arch}}",
	HelpDescription:  "shfmt - A shell parser, formatter, and interpreter",
	HelpLink:         "https://github.com/mvdan/sh",
	ArchiveType:      "none",
}

// New creates a new shfmt plugin instance.
func New() asdf.Plugin {
	return asdf.NewBinaryPlugin(&config)
}

// NewWithClient creates a new shfmt plugin with a custom GitHub client.
