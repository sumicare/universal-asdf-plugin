...
var config = asdf.BinaryPluginConfig{
	...
	FileNameTemplate: "kind-{{.Platform}}-{{.Arch}}",
	HelpDescription:  "kind - Kubernetes IN Docker",
	HelpLink:         "https://github.com/kubernetes-sigs/kind",
	ArchiveType:      "none",
}

// New creates a new kind plugin instance.
func New() asdf.Plugin {
	return asdf.NewBinaryPlugin(&config)
}

// NewWithClient creates a new kind plugin with a custom GitHub client.
