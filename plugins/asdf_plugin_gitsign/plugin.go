...
var config = asdf.BinaryPluginConfig{
	...
	FileNameTemplate: "gitsign_{{.Version}}_{{.Platform}}_{{.Arch}}",
	HelpDescription:  "gitsign - Keyless Git signing with Sigstore",
	HelpLink:         "https://github.com/sigstore/gitsign",
	ArchiveType:      "none",
}

// New creates a new gitsign plugin instance.
func New() asdf.Plugin {
	return asdf.NewBinaryPlugin(&config)
}

// NewWithClient creates a new gitsign plugin with a custom GitHub client.
