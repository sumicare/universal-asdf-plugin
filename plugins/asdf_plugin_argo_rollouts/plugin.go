...
package asdf_plugin_argo_rollouts
...
var config = asdf.BinaryPluginConfig{
	Name:             "argo-rollouts",
	RepoOwner:        "argoproj",
	RepoName:         "argo-rollouts",
	BinaryName:       "kubectl-argo-rollouts",
	FileNameTemplate: "kubectl-argo-rollouts-{{.Platform}}-{{.Arch}}",
	ArchMap: map[string]string{
		"amd64": "amd64",
		"arm64": "arm64",
	},
	HelpDescription: "Argo Rollouts - Progressive Delivery for Kubernetes",
	HelpLink:        "https://argoproj.github.io/argo-rollouts/",
}

// New creates a new Argo Rollouts plugin instance.
func New() asdf.Plugin {
	return asdf.NewBinaryPlugin(&config)
}

// NewWithClient creates a new Argo Rollouts plugin with a custom GitHub client.
