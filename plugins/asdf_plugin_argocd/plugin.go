...
var config = asdf.BinaryPluginConfig{
	...
	RepoName:         "argo-cd",
	BinaryName:       "argocd",
	FileNameTemplate: "argocd-{{.Platform}}-{{.Arch}}",
	ArchMap: map[string]string{
		"amd64": "amd64",
		"arm64": "arm64",
	},
	HelpDescription: "ArgoCD - Declarative GitOps CD for Kubernetes",
	HelpLink:        "https://argoproj.github.io/argocd/",
}

// New creates a new ArgoCD plugin instance.
func New() asdf.Plugin {
	return asdf.NewBinaryPlugin(&config)
}

// NewWithClient creates a new ArgoCD plugin with a custom GitHub client.
