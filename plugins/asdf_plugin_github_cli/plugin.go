...
package asdf_plugin_github_cli
...
var config = asdf.BinaryPluginConfig{
	...
	FileNameTemplate: "gh_{{.Version}}_{{.Platform}}_{{.Arch}}.tar.gz",
	HelpDescription:  "GitHub CLI - GitHub's official command line tool",
	HelpLink:         "https://github.com/cli/cli",
	ArchiveType:      "tar.gz",
}

// New creates a new github-cli plugin instance.
func New() asdf.Plugin {
	return asdf.NewBinaryPlugin(&config)
}

// NewWithClient creates a new github-cli plugin with a custom GitHub client.
