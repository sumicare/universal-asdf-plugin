...
var config = asdf.BinaryPluginConfig{
	...
	FileNameTemplate: "aws-nuke-v{{.Version}}-{{.Platform}}-{{.Arch}}.tar.gz",
	HelpDescription:  "aws-nuke - Remove all resources from an AWS account",
	HelpLink:         "https://github.com/ekristen/aws-nuke",
	ArchiveType:      "tar.gz",
}

// New creates a new aws-nuke plugin instance.
func New() asdf.Plugin {
	return asdf.NewBinaryPlugin(&config)
}

// NewWithClient creates a new aws-nuke plugin with a custom GitHub client.
