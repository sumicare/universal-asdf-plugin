...
var config = asdf.BinaryPluginConfig{
	...
	RepoName:         "yq",
	BinaryName:       "yq",
	FileNameTemplate: "yq_{{.Platform}}_{{.Arch}}",
	HelpDescription:  "yq - a portable command-line YAML processor",
	HelpLink:         "https://mikefarah.gitbook.io/yq/",

	VersionFilter: `^\d+\.\d+\.\d+`,
}

// New creates a new Yq plugin instance.
func New() asdf.Plugin {
	return asdf.NewBinaryPlugin(&config)
}

// NewWithClient creates a new Yq plugin with a custom GitHub client.
