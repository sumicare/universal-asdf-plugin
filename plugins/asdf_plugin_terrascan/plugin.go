...
var config = asdf.BinaryPluginConfig{
	...
	FileNameTemplate: "terrascan_{{.Version}}_{{.Platform}}_{{.Arch}}.tar.gz",
	...
	HelpDescription: "Terrascan - Detect compliance and security violations",
	HelpLink:        "https://github.com/tenable/terrascan",
	ArchiveType:     "tar.gz",
}

// New creates a new terrascan plugin instance.
func New() asdf.Plugin {
	return asdf.NewBinaryPlugin(&config)
}

// NewWithClient creates a new terrascan plugin with a custom GitHub client.
