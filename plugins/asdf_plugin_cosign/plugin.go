...
var config = asdf.BinaryPluginConfig{
	...
	RepoName:         "cosign",
	BinaryName:       "cosign",
	FileNameTemplate: "cosign-{{.Platform}}-{{.Arch}}",
	HelpDescription:  "Cosign container signing",
	HelpLink:         "https://docs.sigstore.dev/cosign/",
}

// New creates a new Cosign plugin instance.
func New() asdf.Plugin {
	return asdf.NewBinaryPlugin(&config)
}

// NewWithClient creates a new Cosign plugin with a custom GitHub client.
