...
var config = asdf.BinaryPluginConfig{
	...
	FileNameTemplate: "syft_{{.Version}}_{{.Platform}}_{{.Arch}}.tar.gz",
	HelpDescription:  "Syft - A CLI tool for generating SBOMs",
	HelpLink:         "https://github.com/anchore/syft",
	ArchiveType:      "tar.gz",
}

// New creates a new Syft plugin instance.
func New() asdf.Plugin {
	return asdf.NewBinaryPlugin(&config)
}

// NewWithClient creates a new Syft plugin with a custom GitHub client.
