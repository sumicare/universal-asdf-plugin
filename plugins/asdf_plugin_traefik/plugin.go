...
var config = asdf.BinaryPluginConfig{
	...
	FileNameTemplate: "traefik_v{{.Version}}_{{.Platform}}_{{.Arch}}.tar.gz",
	HelpDescription:  "Traefik - Cloud Native Application Proxy",
	HelpLink:         "https://traefik.io/",
	ArchiveType:      "tar.gz",
	VersionFilter:    `^\d+\.\d+\.\d+$`,
}
...
// NewWithClient creates a new Traefik plugin with a custom GitHub client.
